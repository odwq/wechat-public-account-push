export const config = {
  ...
  // 如果你非要填这里也行。脚本也能运行
  // APP_ID: "wx554be36ba0e3b04c",

  // 公众号APP_SECRET 
  // 建议不要填这里，请使用文档中github secret的方法进行保密配置，保护您的隐私安全。
  // 如果你非要填这里也行。脚本也能运行
  // APP_SECRET: "01b8d8b56991ba94dd01e3dc48b0bc61",

  /**
   * 接收公众号消息的微信号，如果有多个，需要在[]里用英文逗号间隔，例如
   * [ofBYU52Sqvy9130UFpzGIFjF_2cE
   *  {
   *    // 想要发送的人的名字
   *    name: "老婆0",
  ...
  CALLBACK_USERS: [ofBYU54FO80O8IH05NjxBzdRc-qA
    {
      // 一般都填自己
      name: "自己",
   ...
   */
  FESTIVALS: [
    {"type": "生日", "name": "老婆", "year": "2005", "date": "04-06"},
    {"type": "节日", "name": "结婚纪念日", "year": "2022", "date": "01-08"},
  ...
  CUSTOMIZED_DATE_LIST: [
    // 在一起的日子
    {"keyword": "love_day", date: "2022-01-08"},
